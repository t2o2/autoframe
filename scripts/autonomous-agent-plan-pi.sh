...
LOG_DIR="$SCRIPT_DIR/autonomous-plan-pi-logs"
PROCESSED_FILE="/tmp/autonomous-plan-pi-processed.txt"
...
process_ticket() {
    ...
    local lock_dir="/tmp/plan-pi-lock-${ticket_id}"
    ...
    local owner_pid_file="/tmp/plan-pi-owner-${ticket_id}.pid"
...
main() {
    divider "═"
    log INFO "  Autonomous Planning Agent (pi)"
